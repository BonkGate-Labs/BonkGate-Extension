// BonkGate - Web3 Intelligence Extension Background Script
const API_BASE_URL = 'https://www.bonkgate.fun/api/';

// Extension installation handler
chrome.runtime.onInstalled.addListener(() => {
    console.log('BonkGate Extension installed');
...
async function handleScanRequest(scanType, username) {
    try {
        ...
        */
        ...
        console.error('BonkGate API error:', error);
        return {
            error: true,
    ...
    const mockResponses = {
        ...
        'bio-history': {
            ...
            data: {
                bio_changes: [
                    {
                        bio: 'Web3 enthusiast | Building @BonkGate | Previously @BigTechCo',
